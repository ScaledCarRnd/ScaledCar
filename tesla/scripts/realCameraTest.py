# This script is to test if the real life objects get detected and the correct distance gets outputed
import rospy
import sys
import argparse
...
class realCamTest:
    ...
    def __init__(self):
        ...
        parser.add_argument("input", type=str, default="csi://0, input-flip=rotate180", nargs='?', help="URI of the input stream")
        ...
        while True:
            ...
            for detection in detections:
                ...
                if detection.ClassID == 1:
                    ...
                    # Find the object distance from the camera
